...
describe('CompletionScreen - Rendering', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
...
describe('CompletionScreen - Time Formatting', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
...
describe('CompletionScreen - Cost Formatting', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
...
describe('CompletionScreen - Next Steps', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
...
describe('CompletionScreen - New Project Button', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
