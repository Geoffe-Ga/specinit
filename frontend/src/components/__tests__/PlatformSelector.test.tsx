...
describe('PlatformSelector - Rendering', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
...
describe('PlatformSelector - Selection State', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
...
describe('PlatformSelector - Toggle Behavior', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
...
describe('PlatformSelector - Error Display', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
