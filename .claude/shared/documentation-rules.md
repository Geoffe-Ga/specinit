...
| Architectural decisions | `plan/` directory |
| Team guides | `.claude/agents/` |
| Product specs | `plan/product-spec.md` |
| Progress tracking | `plan/progress-notes.md` |

## Rules

- Write ALL findings, decisions, and outputs as GitHub issue comments
- Link to comprehensive docs in `plan/` and `.claude/agents/` (don't duplicate)
